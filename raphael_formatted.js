    ...
    return function(t) {
        ...
        void 0 === (n = function(t) {
            function e(i) {
                ...
                if (e.is(i, T))
                    return e._engine.create[c](e, i.splice(0, 3 + e.is(i[0], A))).add(i);
            ...
            }, c = "apply", f = "concat", p = "ontouchstart"in l.win || l.win.DocumentTouch && l.doc instanceof DocumentTouch, d = "", g = " ", x = String, v = "split", y = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel"[v](g), m = {
                mousedown: "touchstart",
                mousemove: "touchmove",
                mouseup: "touchend"
            }, b = x.prototype.toLowerCase, _ = Math, w = _.max, k = _.min, B = _.abs, C = _.pow, S = _.PI, A = "number", T = "array", M = Object.prototype.toString, E = (e._ISURL = /^url\(['"]?(.+?)['"]?\)$/i,
            /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i), N = {
                ...
                hs: 1,
                rg: 1
            }, O = /,?([achlmqrstvxz]),?/gi, V = /([achlmrqstvz])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, Y = /([rstm])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, W = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/gi, G = (e._radial_gradient = /^r(?:\(([^,]+?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*([^\)]+?)\))?/,
            {}), H = function(t, e) {
                return z(t) - z(e)
            }, X = function(t) {
                return t
            ...
            e.parsePathString = function(t) {
                ...
                var i = {
                  ...
                  , n = [];
                return e.is(t, T) && e.is(t[0], T) && (n = mt(t)),
            ...
            e.parseTransformString = ht(function(t) {
                if (!t)
                    return null;
                var r = [];
                return e.is(t, T) && e.is(t[0], T) && (r = mt(t)),
                r.length || x(t).replace(Y, function(t, e, i) {
                    var n = [];
                    b.call(e);
            ...
            function vt(t, r, i) {
                ...
                for (var n, a, s, o, l, h, u, c, f, p, d = i ? 0 : [], g = 0, x = t.length; g < x; g++) {
                    ...
                    if ("M" == v[0])
                        ...
                        "C" == v[0] ? (n = (f = [n, a].concat(v.slice(1)))[6],
                        ...
                        for (var y = 0, m = r.length; y < m; y++) {
                            ...
                            if ("M" == b[0])
                                ...
                                "C" == b[0] ? (s = (p = [s, o].concat(b.slice(1)))[6],
            ...
            var yt = e.pathBBox = function(t) {
              ...
              , _t = e._pathToAbsolute = function(t) {
                ...
                if (r.abs)
                    return mt(r.abs);
                if (e.is(t, T) && e.is(t && t[0], T) || (t = e.parsePathString(t)),
                !t || !t.length)
                    return [["M", 0, 0]];
                var i = []
                  , n = 0
            ...
            Yt.removeData = function(t) {
                return null == t ? G[this.id] = {} : G[this.id] && delete G[this.id][t],
                this
            }
            ,
            Yt.getData = function() {
            ...
            Yt.drag = function(r, i, n, a, s, o) {
                function h(h) {
                    ...
                    t("raphael.drag.start." + this.id, s || a || this, h.clientX + d, h.clientY + f, h)
                }
                return this._drag = {},
                Gt.push({
                    el: this,
                ...
                return null == h ? dt(t, r, i, n, a, s, o, l) : e.findDotsAtSegment(t, r, i, n, a, s, o, l, function(t, e, r, i, n, a, s, o, l) {
                    if (!(l < 0 || dt(t, e, r, i, n, a, s, o) < l)) {
                        ...
                        for (h = dt(t, e, r, i, n, a, s, o, c); B(h - l) > .01; )
                            u /= 2,
                            h = dt(t, e, r, i, n, a, s, o, c += (h < l ? 1 : -1) * u);
                        return c
                    }
                }(t, r, i, n, a, s, o, l, h))
            }
            ...
            var oe, le, he = function(t) {
                ...
                t)
                    for (var e = 0, r = t.length; e < r; e++)
                        !t[e] || t[e].constructor != Yt.constructor && t[e].constructor != he || (this[this.items.length] = this.items[this.items.length] = t[e],
                        this.length++)
            }, ue = he.prototype;
            for (var ce in ue.push = function() {
                for (var t, e, r = 0, i = arguments.length; r < i; r++)
                    !(t = arguments[r]) || t.constructor != Yt.constructor && t.constructor != he || (this[e = this.items.length] = this.items[e] = t,
                    this.length++);
                return this
            }
            ,
                    ...
                    for (var y = a.face.bbox[v](n), m = +y[0], b = y[3] - y[1], _ = 0, B = +y[1] + ("baseline" == o ? b + +a.face.descent : b / 2), C = 0, S = c.length; C < S; C++) {
                        if ("\n" == c[C])
                            ...
                            var A = p && a.glyphs[c[C - 1]] || {}
                              , T = a.glyphs[c[C]];
                            f += p ? (A.w || a.w) + (A.k && A.k[c[C]] || 0) + a.w * l : 0,
                            p = 1
                        }
        ...
        void 0 === (n = function(t) {
            if (!t || t.vml) {
                ...
                var k, B = function(t, e, i) {
                    ...
                    if ("arrow-start"in l && B(A, l["arrow-start"]),
                    ...
                    null != l.opacity || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
                        ...
                        j.on && l.fill) {
                            ...
                            if (I) {
                                ...
                                j.src = f,
                                j.type = "solid",
                                t.getRGB(l.fill).error && (A.type in {
                                    circle: 1,
                                    ellipse: 1
                                } || "r" != r(l.fill).charAt()) && S(A, l.fill, j) && (g.fill = "none",
                                g.gradient = l.fill,
                                j.rotate = !1)
                        }
                        ...
                        q = ((+g["stroke-opacity"] + 1 || 2) - 1) * ((+g.opacity + 1 || 2) - 1) * ((+Y.o + 1 || 2) - 1);
                    ...
                    if ("text" == A.type) {
                        ...
                        v.fontSize = 100 * X + "px",
                        A.textpath.string && (H.innerHTML = r(A.textpath.string).replace(/</g, "&#60;").replace(/&/g, "&#38;").replace(/\n/g, "<br>"));
                        var U = H.getBoundingClientRect();
                        A.W = g.w = (U.right - U.left) / 100,
                        A.H = g.h = (U.bottom - U.top) / 100,
                        A.X = g.x,
                        A.Y = g.y + A.H / 2,
                        ("x"in l || "y"in l) && (A.path.v = t.format("m{0},{1}l{2},{1}", a(g.x * y), a(g.y * y), a(g.x * y) + 1));
